...
/***/ function(module, exports) {
	...
	var tags = document.getElementsByClassName("linkable_tag");
	for (var i = tags.length - 1; i >= 0; i--) {
		tags[i].style.cursor = 'pointer';
		tags[i].addEventListener('click', function () {
			var locate = this.getAttribute("href") || this.href;
	...
	string.addEventListener('mouseover', function () {
		line.style.boxShadow = '0 0 20px rgba(0,255,214,1)';
		spot.style.boxShadow = '0 0 20px rgba(0,255,214,1)';
	});
	string.addEventListener('mouseleave', function () {
		line.style.boxShadow = '0 0 8px rgba(0,255,214,1)';
		spot.style.boxShadow = '0 0 8px rgba(0,255,214,1)';
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var index_css = __webpack_require__(92);
	var index_js = __webpack_require__(88);
	var index_jsx = __webpack_require__(89);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.i, ".ball_nav_wrapper{\n\tposition: relative;\n\twidth: 300px;\n\theight: 200px;\n\tmargin: 0 auto;\n}\n.ball{\n\twidth: 50px;\n\theight: 50px;\n\t-webkit-border-radius: 50%;\n\t        border-radius: 50%;\n\tbackground-color: rgba(255,0,0,1);\n\tposition: absolute;\n}\n.around{\n\t/*top: 30px;*/\n\tbackground-color: rgba(255,0,0,0);\n\tleft: 0px;\n\ttop: 0px;\n\t-webkit-transition: 0.8s;\n\ttransition: 0.8s\n}\n*{\n\tpadding:0;\n\tmargin:0;\n\t/*cursor: url('../cursor/cursors/08.cur'),auto;*/\n}\nbody{\n\tmin-width: 360px;\n}\n.header{\n\theight: 150px;\n\t-webkit-box-shadow: 0 0 10px #999;\n\t        box-shadow: 0 0 10px #999;\n}\n.main_wrpper{\n\t/*float: left;*/\n}\n.main{ \n\twidth: 70%;\n\tmargin: 0 auto;\n\tdisplay: -webkit-box;\n\tdisplay: -webkit-flex;\n\tdisplay: -ms-flexbox;\n\tdisplay: flex;\n\t-webkit-justify-content: space-around;\n\t    -ms-flex-pack: distribute;\n\t        justify-content: space-around;\n\t-webkit-flex-wrap: wrap;\n\t    -ms-flex-wrap: wrap;\n\t        flex-wrap: wrap;\n\t-webkit-box-align: center;\n\t-webkit-align-items: center;\n\t    -ms-flex-align: center;\n\t        align-items: center;\n\tmargin-top: 10px;\n}\n.persons_wrapper{\n\twidth: 100%;\n\tposition: relative;\n}\n.person_item{\n\twidth: 100%;\n\theight: 200px;\n\tmargin: 20px;\n\t-webkit-box-shadow: 0 0 10px #666;\n\t        box-shadow: 0 0 10px #666;\n\tfont-size: 100px;\n\ttext-align: center;\n\t-webkit-transition:0.5s;\n\ttransition: 0.5s;\n}\n.person_item:hover{\n\t-webkit-transform: scale(1.02);\n\t    -ms-transform: scale(1.02);\n\t        transform: scale(1.02);\n}\n.footer{\n\theight: 200px;\n}\n\n.side{\n\tposition: fixed;\n\twidth: 100px;\n\t/*height: 100px;*/\n\tright: 20px;\n\tbottom: 20px;\n}\n.side div{\n\twidth: 70px;\n\theight: 70px;\n\tmargin: 15px;\n\t-webkit-box-shadow: 0 0 5px #999;\n\tbox-shadow: 0 0 5px #999;\n\t-webkit-transition: 0.5s;\n\ttransition: 0.5s;\n}\n.side div:hover{\n\tcolor: #ff0;\n\tbackground-color:rgba(100,100,100,0.3);\n}\n/*@font-face {\n\tfont-family: myfont;\n\tsrc: url('../../fonts/fonts2/4.ttf') format('truetype');\n}*/\n.welcome{\n\tbackground-color: #000;\n\tposition: fixed;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 100;\n}\n.logo_416_container{\n\tdisplay: -webkit-box;\n\tdisplay: -webkit-flex;\n\tdisplay: -ms-flexbox;\n\tdisplay: flex;\n\twidth: 100%;\n\theight: 100%;\n\tposition: absolute;\n\tleft: 0;\n\ttop: 0;\n\t-webkit-box-pack: center;\n\t-webkit-justify-content: center;\n\t    -ms-flex-pack: center;\n\t        justify-content: center;\n\t-webkit-box-align: center;\n\t-webkit-align-items: center;\n\t    -ms-flex-align: center;\n\t        align-items: center;\n}\n.logo_416{\n\twidth: 430px;\n\tfont-family: monospace;\n\tcolor: rgba(0,255,214,1);\n\ttext-shadow: 0 0 8px rgba(0,255,214,1);\n}\n.wrapper_416{\n\tposition: relative;\n\tdisplay: -webkit-box;\n\tdisplay: -webkit-flex;\n\tdisplay: -ms-flexbox;\n\tdisplay: flex;\n\t-webkit-box-pack: center;\n\t-webkit-justify-content: center;\n\t    -ms-flex-pack: center;\n\t        justify-content: center;\n\t-webkit-box-align: center;\n\t-webkit-align-items: center;\n\t    -ms-flex-align: center;\n\t        align-items: center;\n\twidth: 300px;\n\theight: 150px;\n}\n.wrapper_416 span:nth-child(1){\n\tfont-size: 100px;\n\t}\n.wrapper_416 span:nth-child(2){\n\tfont-size: 75px;\n\t}\n.wrapper_416 span:nth-child(3){\n\tfont-size: 120px;\n\t}\n.words{\n\tposition: relative;\n\twidth: 150px;\n\tleft: 70%;\n\tbottom:15px; \n\tfont-size: 25px;\n}\n@media screen and (max-width: 450px){\n\t.words{\n\t\tleft: 200px;\n\t}\n}\n.light_container{\n\tdisplay: -webkit-box;\n\tdisplay: -webkit-flex;\n\tdisplay: -ms-flexbox;\n\tdisplay: flex;\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n\tleft: 0;\n\ttop: 0;\n\t-webkit-box-pack: center;\n\t-webkit-justify-content: center;\n\t    -ms-flex-pack: center;\n\t        justify-content: center;\n\t-webkit-box-align: center;\n\t-webkit-align-items: center;\n\t    -ms-flex-align: center;\n\t        align-items: center;\n\t-webkit-flex-wrap: wrap;\n\t    -ms-flex-wrap: wrap;\n\t        flex-wrap: wrap;\n}\n.light{\n\twidth: 30%;\n\theight: 20%;\n\t-webkit-filter: blur(85px);\n\t        filter: blur(85px);\n\t-ms-filter: blur(85px); \n\tfilter:progid:DXImageTransform.Microsoft.Blur(pixelRadius=85,   MakeShadow=false);\n\tbackground-color: rgba(0,255,214,0.2);\n\t-webkit-transition: 2s linear;\n\ttransition: 2s linear;\n\tbehavior: url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./ie-css3.htc\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ");\n}\n.star{\n\tposition: absolute;\n\t-webkit-border-radius: 50%;\n\t        border-radius: 50%;\n\t-webkit-transition: all 1s linear;\n\ttransition: all 1s linear;\n}\n.canvas{\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n\tleft: 0;\n\ttop:0;\n}\n.string{\n\tposition: absolute;\n\twidth: 20px;\n\theight: 50%;\n\tleft: 58%;\n\tz-index: 99;\n}\n@media screen and (max-width: 450px){\n\t.string{\n\t\tleft: 70%;\n\t}\n}\n.line{\n\twidth: 2px;\n\theight: 90%;\n\tmargin: 0 auto;\n\tbackground-color: rgba(0,255,214,1);\n\t-webkit-box-shadow: 0 0 8px rgba(0,255,214,1);\n\t        box-shadow: 0 0 8px rgba(0,255,214,1);\n\t-webkit-transition: 0.5s ease-in-out;\n\ttransition: 0.5s ease-in-out;\n}\n.spot{\n\tposition: relative;\n\twidth: 20px;\n\theight: 20px;\n\tmargin: 0 auto;\n\t-webkit-border-radius: 50%;\n\t        border-radius: 50%;\n\tbackground-color: rgba(0,255,214,1);\n\t-webkit-box-shadow: 0 0 8px rgba(0,255,214,1);\n\t        box-shadow: 0 0 8px rgba(0,255,214,1);\n}\n.spot_inside{\n\tposition: absolute;\n\twidth: 6px;\n\theight: 6px;\n\tmargin: 7px 7px;\n\t-webkit-border-radius: 50%;\n\t        border-radius: 50%;\n\tbackground-color: #000;\n\t-webkit-box-shadow: 0 0 8px #003c32;\n\t        box-shadow: 0 0 8px #003c32;\n}\n.ring_inside{\n\tposition: absolute;\n\twidth: 18px;\n\theight: 18px;\n\tleft: 1px;\n\ttop: 1px;\n\t-webkit-border-radius: 50%;\n\t        border-radius: 50%;\n\tborder-color: rgba(0,255,214,1);\n\tborder-width: 2px;\n\t-webkit-box-shadow: 0 0 1px rgba(0,255,214,1);\n\t        box-shadow: 0 0 1px rgba(0,255,214,1);\n\t-webkit-transition: 0.2s;\n\ttransition: 0.2s;\n}\n.ring_inside:hover{\n\t-webkit-transform: scale(1.6);\n\t    -ms-transform: scale(1.6);\n\t        transform: scale(1.6);\n}\n/*# sourceMappingURL=all.css.map */\n", ""]);
